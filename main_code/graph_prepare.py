...
if __name__ == '__main__':
    ...
    if dataset in ['contact', 'davis']:
        ...
        proteins = json.load(open('/home/layomi/drive1/项目代码/HLA-II_code/HLAII_MODEL/dataset/hla_sequnence_dict.csv'), object_pairs_hook=OrderedDict)
    ...
    save_dir='../dataset/pre_process/contact/'
